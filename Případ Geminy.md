...
1.  **Limit kontextového okna:** Model začal „zapomínat“ dřívější architektonická rozhodnutí, aby uvolnil místo pro nové úseky kódu.
2.  **Chat jako editor:** Používání chatovacího rozhraní jako náhrady za IDE vedlo k halucinacím o cestách k souborům, které v lokálním systému neexistovaly.
